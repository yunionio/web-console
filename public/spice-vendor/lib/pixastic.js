...
if (typeof jQuery !== 'undefined' && jQuery && jQuery.fn) {
  jQuery.fn.pixastic = function (action, options) {
    ...
    if (newElements.length > 0) { return jQuery(newElements) } else { return this }
  }
};
/*
    ...
    if (Pixastic.Client.hasCanvasImageData()) {
      ...
      switch (mode) {
        ...
        case 'lineardodge' :
          ...
          while (p--) {
            if ((r3 = data[pix -= 4] + data2[pix]) > 255) { data2[pix] = 255 } else { data2[pix] = r3 }
            if ((g3 = data[pix1 = pix + 1] + data2[pix1]) > 255) { data2[pix1] = 255 } else { data2[pix1] = g3 }
        ...
        case 'linearburn' :
          while (p--) {
            if ((r3 = data[pix -= 4] + data2[pix]) < 255) { data2[pix] = 0 } else { data2[pix] = (r3 - 255) }
            if ((g3 = data[pix1 = pix + 1] + data2[pix1]) < 255) { data2[pix1] = 0 } else { data2[pix1] = (g3 - 255) }
            if ((b3 = data[pix2 = pix + 2] + data2[pix2]) < 255) { data2[pix2] = 0 } else { data2[pix2] = (b3 - 255) }
          }
          dataChanged = true
          break
        ...
        case 'difference' :
          while (p--) {
            if ((r3 = data[pix -= 4] - data2[pix]) < 0) { data2[pix] = -r3 } else { data2[pix] = r3 }
            if ((g3 = data[pix1 = pix + 1] - data2[pix1]) < 0) { data2[pix1] = -g3 } else { data2[pix1] = g3 }
            if ((b3 = data[pix2 = pix + 2] - data2[pix2]) < 0) { data2[pix2] = -b3 } else { data2[pix2] = b3 }
          }
          dataChanged = true
          break
        ...
        case 'overlay' :
          var div_2_255 = 2 / 255
          while (p--) {
            if ((r1 = data[pix -= 4]) < 128) { data2[pix] = data2[pix] * r1 * div_2_255 } else { data2[pix] = 255 - (255 - data2[pix]) * (255 - r1) * div_2_255 }

            if ((g1 = data[pix1 = pix + 1]) < 128) { data2[pix1] = data2[pix1] * g1 * div_2_255 } else { data2[pix1] = 255 - (255 - data2[pix1]) * (255 - g1) * div_2_255 }

            if ((b1 = data[pix2 = pix + 2]) < 128) { data2[pix2] = data2[pix2] * b1 * div_2_255 } else { data2[pix2] = 255 - (255 - data2[pix2]) * (255 - b1) * div_2_255 }
          }
          dataChanged = true
          break
        ...
        case 'softlight' :
          var div_2_255 = 2 / 255
          while (p--) {
            if ((r1 = data[pix -= 4]) < 128) { data2[pix] = ((data2[pix] >> 1) + 64) * r1 * div_2_255 } else { data2[pix] = 255 - (191 - (data2[pix] >> 1)) * (255 - r1) * div_2_255 }

            if ((g1 = data[pix1 = pix + 1]) < 128) { data2[pix1] = ((data2[pix1] >> 1) + 64) * g1 * div_2_255 } else { data2[pix1] = 255 - (191 - (data2[pix1] >> 1)) * (255 - g1) * div_2_255 }

            if ((b1 = data[pix2 = pix + 2]) < 128) { data2[pix2] = ((data2[pix2] >> 1) + 64) * b1 * div_2_255 } else { data2[pix2] = 255 - (191 - (data2[pix2] >> 1)) * (255 - b1) * div_2_255 }
          }
          dataChanged = true
          break
        ...
        case 'hardlight' :
          var div_2_255 = 2 / 255
          while (p--) {
            if ((r2 = data2[pix -= 4]) < 128) { data2[pix] = data[pix] * r2 * div_2_255 } else { data2[pix] = 255 - (255 - data[pix]) * (255 - r2) * div_2_255 }

            if ((g2 = data2[pix1 = pix + 1]) < 128) { data2[pix1] = data[pix1] * g2 * div_2_255 } else { data2[pix1] = 255 - (255 - data[pix1]) * (255 - g2) * div_2_255 }

            if ((b2 = data2[pix2 = pix + 2]) < 128) { data2[pix2] = data[pix2] * b2 * div_2_255 } else { data2[pix2] = 255 - (255 - data[pix2]) * (255 - b2) * div_2_255 }
          }
          dataChanged = true
          break
        ...
        case 'colordodge' :
          while (p--) {
            if ((r3 = (data[pix -= 4] << 8) / (255 - (r2 = data2[pix]))) > 255 || r2 == 255) { data2[pix] = 255 } else { data2[pix] = r3 }

            if ((g3 = (data[pix1 = pix + 1] << 8) / (255 - (g2 = data2[pix1]))) > 255 || g2 == 255) { data2[pix1] = 255 } else { data2[pix1] = g3 }
        ...
        case 'colorburn' :
          while (p--) {
            if ((r3 = 255 - ((255 - data[pix -= 4]) << 8) / data2[pix]) < 0 || data2[pix] == 0) { data2[pix] = 0 } else { data2[pix] = r3 }

            if ((g3 = 255 - ((255 - data[pix1 = pix + 1]) << 8) / data2[pix1]) < 0 || data2[pix1] == 0) { data2[pix1] = 0 } else { data2[pix1] = g3 }
        ...
        case 'linearlight' :
          while (p--) {
            if (((r3 = 2 * (r2 = data2[pix -= 4]) + data[pix] - 256) < 0) || (r2 < 128 && r3 < 0)) {
              ...
              if (r3 > 255) { data2[pix] = 255 } else { data2[pix] = r3 }
            }
            if (((g3 = 2 * (g2 = data2[pix1 = pix + 1]) + data[pix1] - 256) < 0) || (g2 < 128 && g3 < 0)) {
              data2[pix1] = 0
            } else {
              if (g3 > 255) { data2[pix1] = 255 } else { data2[pix1] = g3 }
            }
            if (((b3 = 2 * (b2 = data2[pix2 = pix + 2]) + data[pix2] - 256) < 0) || (b2 < 128 && b3 < 0)) {
              data2[pix2] = 0
            } else {
              if (b3 > 255) { data2[pix2] = 255 } else { data2[pix2] = b3 }
            }
          }
          dataChanged = true
          break
        ...
        case 'vividlight' :
          while (p--) {
            if ((r2 = data2[pix -= 4]) < 128) {
              if (r2) {
                if ((r3 = 255 - ((255 - data[pix]) << 8) / (2 * r2)) < 0) { data2[pix] = 0 } else { data2[pix] = r3 }
              } else {
                data2[pix] = 0
              }
            } else if ((r3 = (r4 = 2 * r2 - 256)) < 255) {
              if ((r3 = (data[pix] << 8) / (255 - r4)) > 255) { data2[pix] = 255 } else { data2[pix] = r3 }
            } else {
              if (r3 < 0) { data2[pix] = 0 } else { data2[pix] = r3 }
            }

            if ((g2 = data2[pix1 = pix + 1]) < 128) {
              if (g2) {
                if ((g3 = 255 - ((255 - data[pix1]) << 8) / (2 * g2)) < 0) { data2[pix1] = 0 } else { data2[pix1] = g3 }
              } else {
                data2[pix1] = 0
              }
            } else if ((g3 = (g4 = 2 * g2 - 256)) < 255) {
              if ((g3 = (data[pix1] << 8) / (255 - g4)) > 255) { data2[pix1] = 255 } else { data2[pix1] = g3 }
            } else {
              if (g3 < 0) { data2[pix1] = 0 } else { data2[pix1] = g3 }
            }

            if ((b2 = data2[pix2 = pix + 2]) < 128) {
              if (b2) {
                if ((b3 = 255 - ((255 - data[pix2]) << 8) / (2 * b2)) < 0) { data2[pix2] = 0 } else { data2[pix2] = b3 }
              } else {
                data2[pix2] = 0
              }
            } else if ((b3 = (b4 = 2 * b2 - 256)) < 255) {
              if ((b3 = (data[pix2] << 8) / (255 - b4)) > 255) { data2[pix2] = 255 } else { data2[pix2] = b3 }
            } else {
              if (b3 < 0) { data2[pix2] = 0 } else { data2[pix2] = b3 }
            }
          }
          dataChanged = true
          break
        ...
        case 'pinlight' :
          while (p--) {
            if ((r2 = data2[pix -= 4]) < 128) {
              if ((r1 = data[pix]) < (r4 = 2 * r2)) { data2[pix] = r1 } else { data2[pix] = r4 }
            } else
            if ((r1 = data[pix]) > (r4 = 2 * r2 - 256)) { data2[pix] = r1 } else { data2[pix] = r4 }

            if ((g2 = data2[pix1 = pix + 1]) < 128) {
              if ((g1 = data[pix1]) < (g4 = 2 * g2)) { data2[pix1] = g1 } else { data2[pix1] = g4 }
            } else
            if ((g1 = data[pix1]) > (g4 = 2 * g2 - 256)) { data2[pix1] = g1 } else { data2[pix1] = g4 }

            if ((r2 = data2[pix2 = pix + 2]) < 128) {
              if ((r1 = data[pix2]) < (r4 = 2 * r2)) { data2[pix2] = r1 } else { data2[pix2] = r4 }
            } else
            if ((r1 = data[pix2]) > (r4 = 2 * r2 - 256)) { data2[pix2] = r1 } else { data2[pix2] = r4 }
          }
          dataChanged = true
          break
        ...
        case 'hardmix' :
          while (p--) {
            if ((r2 = data2[pix -= 4]) < 128) {
              if (255 - ((255 - data[pix]) << 8) / (2 * r2) < 128 || r2 == 0) { data2[pix] = 0 } else { data2[pix] = 255 }
            } else if ((r4 = 2 * r2 - 256) < 255 && (data[pix] << 8) / (255 - r4) < 128) { data2[pix] = 0 } else { data2[pix] = 255 }

            if ((g2 = data2[pix1 = pix + 1]) < 128) {
              if (255 - ((255 - data[pix1]) << 8) / (2 * g2) < 128 || g2 == 0) { data2[pix1] = 0 } else { data2[pix1] = 255 }
            } else if ((g4 = 2 * g2 - 256) < 255 && (data[pix1] << 8) / (255 - g4) < 128) { data2[pix1] = 0 } else { data2[pix1] = 255 }

            if ((b2 = data2[pix2 = pix + 2]) < 128) {
              if (255 - ((255 - data[pix2]) << 8) / (2 * b2) < 128 || b2 == 0) { data2[pix2] = 0 } else { data2[pix2] = 255 }
            } else if ((b4 = 2 * b2 - 256) < 255 && (data[pix2] << 8) / (255 - b4) < 128) { data2[pix2] = 0 } else { data2[pix2] = 255 }
          }
          dataChanged = true
          break
      }
...
Pixastic.Actions.brightness = {
  ...
  process: function (params) {
    ...
    if (Pixastic.Client.hasCanvasImageData()) {
      ...
      var r, g, b
      while (p--) {
        if ((r = data[pix -= 4] * mul + add) > 255) { data[pix] = 255 } else if (r < 0) { data[pix] = 0 } else { data[pix] = r }

        if ((g = data[pix1 = pix + 1] * mul + add) > 255) { data[pix1] = 255 } else if (g < 0) { data[pix1] = 0 } else { data[pix1] = g }

        if ((b = data[pix2 = pix + 2] * mul + add) > 255) { data[pix2] = 255 } else if (b < 0) { data[pix2] = 0 } else { data[pix2] = b }
      }
      return true
    }
  },
  ...
  process: function (params) {
    ...
    if (Pixastic.Client.hasCanvasImageData()) {
      ...
      while (p--) {
        ...
        if (red) {
          if ((r = data[pix] + red) < 0) { data[pix] = 0 } else if (r > 255) { data[pix] = 255 } else { data[pix] = r }
        }

        if (green) {
          if ((g = data[pix1 = pix + 1] + green) < 0) { data[pix1] = 0 } else if (g > 255) { data[pix1] = 255 } else { data[pix1] = g }
        }

        if (blue) {
          if ((b = data[pix2 = pix + 2] + blue) < 0) { data[pix2] = 0 } else if (b > 255) { data[pix2] = 255 } else { data[pix2] = b }
        }
      }
      return true
    }
...
Pixastic.Actions.glow = {
  process: function (params) {
    ...
    if (Pixastic.Client.hasCanvasImageData()) {
      ...
      var pix = p * 4; var pix1 = pix + 1; var pix2 = pix + 2; var pix3 = pix + 3
      while (p--) {
  ...
  process: function (params) {
    ...
    if (Pixastic.Client.hasCanvasImageData()) {
      ...
      while (p--) {
        ...
        if (hue != 0 || saturation != 0) {
          ...
          if (l > 0) {
            if (vm > 0) {
              ...
              if (r == vs) {
                if (g == ms) { var h = 5 + ((vs - b) / vm) + hue6 } else { var h = 1 - ((vs - g) / vm) + hue6 }
              } else if (g == vs) {
                if (b == ms) { var h = 1 + ((vs - r) / vm) + hue6 } else { var h = 3 - ((vs - b) / vm) + hue6 }
              } else {
                if (r == ms) { var h = 3 + ((vs - g) / vm) + hue6 } else { var h = 5 - ((vs - r) / vm) + hue6 }
              }
              if (h < 0) h += 6
              if (h >= 6) h -= 6
              var m = (l + l - v)
        ...
        if (r < 0) { data[pix] = 0 } else if (r > 255) { data[pix] = 255 } else { data[pix] = r }

        if (g < 0) { data[pix1] = 0 } else if (g > 255) { data[pix1] = 255 } else { data[pix1] = g }

        if (b < 0) { data[pix2] = 0 } else if (b > 255) { data[pix2] = 255 } else { data[pix2] = b }
      }
...
Pixastic.Actions.lighten = {
  ...
  process: function (params) {
    ...
    if (Pixastic.Client.hasCanvasImageData()) {
      ...
      var pix = p * 4; var pix1 = pix + 1; var pix2 = pix + 2
      var mul = amount + 1
    ...
    if (Pixastic.Client.hasCanvasImageData()) {
      ...
      do {
        ...
        do {
          ...
          var r1 = data[offset - 4]; var r2 = data[offset + 4]; var r3 = data[offsetNext]
          if (r1 < minR) minR = r1
          if (r2 < minR) minR = r2
          if (r3 < minR) minR = r3
          if (r1 > maxR) maxR = r1
          ...
          var g1 = data[offset - 3]; var g2 = data[offset + 5]; var g3 = data[offsetNext + 1]
          if (g1 < minG) minG = g1
          if (g2 < minG) minG = g2
          if (g3 < minG) minG = g3
          if (g1 > maxG) maxG = g1
          ...
          var b1 = data[offset - 2]; var b2 = data[offset + 6]; var b3 = data[offsetNext + 2]
          if (b1 < minB) minB = b1
          if (b2 < minB) minB = b2
          if (b3 < minB) minB = b3
          if (b1 > maxB) maxB = b1
