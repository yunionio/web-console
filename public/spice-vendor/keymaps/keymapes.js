...
wdi.KeymapES = (function () {
  ...
  // 使用【发送文字】键盘对应码，未找到charmapES原使用场景，故拷贝一份单独修改
  var charmapNewES = {}
  charmapNewES['º'] = [[0x29, 0, 0, 0], [0xA9, 0, 0, 0]]
  charmapNewES['ª'] = [[0x2A, 0, 0, 0], [0x29, 0, 0, 0], [0xA9, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['\\'] = [[0x2B, 0, 0, 0], [0xAB, 0, 0, 0]]
  charmapNewES['1'] = [[0x2, 0, 0, 0], [0x82, 0, 0, 0]]
  charmapNewES['!'] = [[0x2A, 0, 0, 0], [0x2, 0, 0, 0], [0x82, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['|'] = [[0x2A, 0, 0, 0], [0x2B, 0, 0, 0], [0xAB, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['2'] = [[0x3, 0, 0, 0], [0x83, 0, 0, 0]]
  charmapNewES['"'] = [[0x36, 0, 0, 0], [0x28, 0, 0, 0], [0xB6, 0, 0, 0], [0xA8, 0, 0, 0]]
  charmapNewES['@'] = [[0x2A, 0, 0, 0], [0x3, 0, 0, 0], [0x83, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['3'] = [[0x4, 0, 0, 0], [0x84, 0, 0, 0]]
  charmapNewES['·'] = [[0x2A, 0, 0, 0], [0x4, 0, 0, 0], [0x84, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['#'] = [[0x2A, 0, 0, 0], [0x4, 0, 0, 0], [0x84, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['4'] = [[0x5, 0, 0, 0], [0x85, 0, 0, 0]]
  charmapNewES['$'] = [[0x2A, 0, 0, 0], [0x5, 0, 0, 0], [0x85, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['~'] = [[0x2A, 0, 0, 0], [0x29, 0, 0, 0], [0xA9, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['5'] = [[0x6, 0, 0, 0], [0x86, 0, 0, 0]]
  charmapNewES['%'] = [[0x2A, 0, 0, 0], [0x6, 0, 0, 0], [0x86, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['6'] = [[0x7, 0, 0, 0], [0x87, 0, 0, 0]]
  charmapNewES['&'] = [[0x2A, 0, 0, 0], [0x8, 0, 0, 0], [0x88, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['¬'] = [[0xE0, 0x38, 0, 0], [0x7, 0, 0, 0], [0x87, 0, 0, 0], [0xE0, 0xB8, 0, 0]]
  charmapNewES['7'] = [[0x8, 0, 0, 0], [0x88, 0, 0, 0]]
  charmapNewES['/'] = [[0x35, 0, 0, 0], [0xB5, 0, 0, 0]]
  charmapNewES['8'] = [[0x9, 0, 0, 0], [0x89, 0, 0, 0]]
  charmapNewES['('] = [[0x2A, 0, 0, 0], [0xa, 0, 0, 0], [0x8a, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['9'] = [[0x0A, 0, 0, 0], [0x8A, 0, 0, 0]]
  charmapNewES[')'] = [[0x2A, 0, 0, 0], [0xB, 0, 0, 0], [0x8B, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['0'] = [[0x0B, 0, 0, 0], [0x8B, 0, 0, 0]]
  charmapNewES['='] = [[0x0D, 0, 0, 0], [0x8D, 0, 0, 0]]
  charmapNewES['\''] = [[0x2B, 0, 0, 0], [0xAB, 0, 0, 0]]
  charmapNewES['?'] = [[0x2A, 0, 0, 0], [0x35, 0, 0, 0], [0xB5, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['¡'] = [[0x0D, 0, 0, 0], [0x8D, 0, 0, 0]]
  charmapNewES['¿'] = [[0x2A, 0, 0, 0], [0x0D, 0, 0, 0], [0x8D, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['q'] = [[0x10, 0, 0, 0], [0x90, 0, 0, 0]]
  charmapNewES['Q'] = [[0x2A, 0, 0, 0], [0x10, 0, 0, 0], [0x90, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['w'] = [[0x11, 0, 0, 0], [0x91, 0, 0, 0]]
  charmapNewES['W'] = [[0x2A, 0, 0, 0], [0x11, 0, 0, 0], [0x91, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['e'] = [[0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['E'] = [[0x2A, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['€'] = [[0xE0, 0x38, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0], [0xE0, 0xB8, 0, 0]]
  charmapNewES['r'] = [[0x13, 0, 0, 0], [0x93, 0, 0, 0]]
  charmapNewES['R'] = [[0x2A, 0, 0, 0], [0x13, 0, 0, 0], [0x93, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['t'] = [[0x14, 0, 0, 0], [0x94, 0, 0, 0]]
  charmapNewES['T'] = [[0x2A, 0, 0, 0], [0x14, 0, 0, 0], [0x94, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['y'] = [[0x15, 0, 0, 0], [0x95, 0, 0, 0]]
  charmapNewES['Y'] = [[0x2A, 0, 0, 0], [0x15, 0, 0, 0], [0x95, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['u'] = [[0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['U'] = [[0x2A, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['i'] = [[0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['I'] = [[0x2A, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['o'] = [[0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['O'] = [[0x2A, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['p'] = [[0x19, 0, 0, 0], [0x99, 0, 0, 0]]
  charmapNewES['P'] = [[0x2A, 0, 0, 0], [0x19, 0, 0, 0], [0x99, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['`'] = [[0x29, 0, 0, 0], [0xA9, 0, 0, 0]]
  charmapNewES['à'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['À'] = [[0xAA, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x2A, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['è'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['È'] = [[0xAA, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x2A, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['ì'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['Ì'] = [[0xAA, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x2A, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['ò'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['Ò'] = [[0xAA, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x2A, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['ù'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['Ù'] = [[0xAA, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x2A, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['â'] = [[0x2A, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0xAA, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['Â'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['ê'] = [[0x2A, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0xAA, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['Ê'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['î'] = [[0x2A, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0xAA, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['Î'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['ô'] = [[0x2A, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0xAA, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['Ô'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['û'] = [[0x2A, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0xAA, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['Û'] = [[0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['^'] = [[0x2A, 0, 0, 0], [0x07, 0, 0, 0], [0x87, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['['] = [[0xE0, 0x38, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0xE0, 0xB8, 0, 0]]
  charmapNewES['+'] = [[0x2A, 0, 0, 0], [0xD, 0, 0, 0], [0x8D, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['*'] = [[0x2A, 0, 0, 0], [0x9, 0, 0, 0], [0x89, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES[']'] = [[0xE0, 0x38, 0, 0], [0x1B, 0, 0, 0], [0x9B, 0, 0, 0], [0xE0, 0xB8, 0, 0]]
  charmapNewES['a'] = [[0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['A'] = [[0x2A, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['s'] = [[0x1F, 0, 0, 0], [0x9F, 0, 0, 0]]
  charmapNewES['S'] = [[0x2A, 0, 0, 0], [0x1F, 0, 0, 0], [0x9F, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['d'] = [[0x20, 0, 0, 0], [0xA0, 0, 0, 0]]
  charmapNewES['D'] = [[0x2A, 0, 0, 0], [0x20, 0, 0, 0], [0xA0, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['f'] = [[0x21, 0, 0, 0], [0xA1, 0, 0, 0]]
  charmapNewES['F'] = [[0x2A, 0, 0, 0], [0x21, 0, 0, 0], [0xA1, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['g'] = [[0x22, 0, 0, 0], [0xA2, 0, 0, 0]]
  charmapNewES['G'] = [[0x2A, 0, 0, 0], [0x22, 0, 0, 0], [0xA2, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['h'] = [[0x23, 0, 0, 0], [0xA3, 0, 0, 0]]
  charmapNewES['H'] = [[0x2A, 0, 0, 0], [0x23, 0, 0, 0], [0xA3, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['j'] = [[0x24, 0, 0, 0], [0xA4, 0, 0, 0]]
  charmapNewES['J'] = [[0x2A, 0, 0, 0], [0x24, 0, 0, 0], [0xA4, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['k'] = [[0x25, 0, 0, 0], [0xA5, 0, 0, 0]]
  charmapNewES['K'] = [[0x2A, 0, 0, 0], [0x25, 0, 0, 0], [0xA5, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['l'] = [[0x26, 0, 0, 0], [0xA6, 0, 0, 0]]
  charmapNewES['L'] = [[0x2A, 0, 0, 0], [0x26, 0, 0, 0], [0xA6, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['ñ'] = [[0x27, 0, 0, 0], [0xA7, 0, 0, 0]]
  charmapNewES['Ñ'] = [[0x2A, 0, 0, 0], [0x27, 0, 0, 0], [0xA7, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['á'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['Á'] = [[0xAA, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x2A, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['é'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['É'] = [[0xAA, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x2A, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['í'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['Í'] = [[0xAA, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x2A, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['ó'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['Ó'] = [[0xAA, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x2A, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['ú'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['Ú'] = [[0xAA, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x2A, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['ä'] = [[0x2A, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0xAA, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['Ä'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x1E, 0, 0, 0], [0x9E, 0, 0, 0]]
  charmapNewES['ë'] = [[0x2A, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0xAA, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['Ë'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x12, 0, 0, 0], [0x92, 0, 0, 0]]
  charmapNewES['ï'] = [[0x2A, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0xAA, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['Ï'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x17, 0, 0, 0], [0x97, 0, 0, 0]]
  charmapNewES['ö'] = [[0x2A, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0xAA, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['Ö'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x18, 0, 0, 0], [0x98, 0, 0, 0]]
  charmapNewES['ü'] = [[0x2A, 0, 0, 0], [0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0xAA, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['Ü'] = [[0x28, 0, 0, 0], [0xA8, 0, 0, 0], [0x16, 0, 0, 0], [0x96, 0, 0, 0]]
  charmapNewES['{'] = [[0x2A, 0, 0, 0], [0x1A, 0, 0, 0], [0x9A, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['ç'] = [[0x2B, 0, 0, 0], [0xAB, 0, 0, 0]]
  charmapNewES['Ç'] = [[0x2A, 0, 0, 0], [0x2B, 0, 0, 0], [0xAB, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['}'] = [[0x2A, 0, 0, 0], [0x1B, 0, 0, 0], [0x9B, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['<'] = [[0x2A, 0, 0, 0], [0x33, 0, 0, 0], [0xB3, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['>'] = [[0x2A, 0, 0, 0], [0x34, 0, 0, 0], [0xB4, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['z'] = [[0x2C, 0, 0, 0], [0xAC, 0, 0, 0]]
  charmapNewES['Z'] = [[0x2A, 0, 0, 0], [0x2C, 0, 0, 0], [0xAC, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['x'] = [[0x2D, 0, 0, 0], [0xAD, 0, 0, 0]]
  charmapNewES['X'] = [[0x2A, 0, 0, 0], [0x2D, 0, 0, 0], [0xAD, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['c'] = [[0x2E, 0, 0, 0], [0xAE, 0, 0, 0]]
  charmapNewES['C'] = [[0x2A, 0, 0, 0], [0x2E, 0, 0, 0], [0xAE, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['v'] = [[0x2F, 0, 0, 0], [0xAF, 0, 0, 0]]
  charmapNewES['V'] = [[0x2A, 0, 0, 0], [0x2F, 0, 0, 0], [0xAF, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['b'] = [[0x30, 0, 0, 0], [0xB0, 0, 0, 0]]
  charmapNewES['B'] = [[0x2A, 0, 0, 0], [0x30, 0, 0, 0], [0xB0, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['n'] = [[0x31, 0, 0, 0], [0xB1, 0, 0, 0]]
  charmapNewES['N'] = [[0x2A, 0, 0, 0], [0x31, 0, 0, 0], [0xB1, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES['m'] = [[0x32, 0, 0, 0], [0xB2, 0, 0, 0]]
  charmapNewES['M'] = [[0x2A, 0, 0, 0], [0x32, 0, 0, 0], [0xB2, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES[','] = [[0x33, 0, 0, 0], [0xB3, 0, 0, 0]]
  charmapNewES[';'] = [[0x27, 0, 0, 0], [0xA7, 0, 0, 0]]
  charmapNewES["'"] = [[0x28, 0, 0, 0], [0xAB, 0, 0, 0]]
  charmapNewES['.'] = [[0x34, 0, 0, 0], [0xB4, 0, 0, 0]]
  charmapNewES[':'] = [[0x36, 0, 0, 0], [0x27, 0, 0, 0], [0xB6, 0, 0, 0], [0xA7, 0, 0, 0]]
  charmapNewES['-'] = [[0x0C, 0, 0, 0], [0x8C, 0, 0, 0]]
  charmapNewES['_'] = [[0x2A, 0, 0, 0], [0xC, 0, 0, 0], [0x8C, 0, 0, 0], [0xAA, 0, 0, 0]]
  charmapNewES[' '] = [[0x39, 0, 0, 0], [0xb9, 0, 0, 0]]
  charmapNewES['\n'] = [[0x1C, 0, 0, 0], [0x9C, 0, 0, 0]]
