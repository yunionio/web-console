...
if [[ -z ${GITHUB_TOKEN:-} ]]; then
  echo "Please export GITHUB_TOKEN=<your-token> (get your token from github setting)"
  exit 1
fi
...
for pull in "${PULLS[@]}"; do
  ...
  curl -H "Authorization: token ${GITHUB_TOKEN}" \
      ...
      -o "/tmp/${pull}.patch" -sSL "https://api.github.com/repos/${MAIN_REPO_ORG}/${MAIN_REPO_NAME}/pulls/${pull}.patch"
  echo
